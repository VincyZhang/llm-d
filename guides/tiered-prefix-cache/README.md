...
> [!IMPORTANT]
> The Intel XPU path uses `amr-registry.caas.intel.com/aiops/catalog/vllm:latest`.
> The deployment overlay in [`modelserver/xpu/vllm/base/kustomization.yaml`](./modelserver/xpu/vllm/base/kustomization.yaml) already points at that image.
